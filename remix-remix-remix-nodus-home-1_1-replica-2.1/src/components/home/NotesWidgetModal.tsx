    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-3.5 space-y-4 scrollbar-thin">
          {/* Keep-style Note Composer */}
          <div className="w-full max-w-md mx-auto">
            <div
              ref={composerRef}
              id="keep-note-composer-modal"
              onClick={() => {
              ...
              className={`w-full transition-all duration-200 overflow-hidden ${
                settings.theme === 'neobrutalism'
                  ...
                  : settings.theme === 'nordic-minimal'
                  ? 'rounded-none border'
                  : 'rounded-xl border backdrop-blur-2xl shadow-xl'
            ...
            >
              {!isComposerExpanded ? (
                ...
                <div className="px-3 py-2 flex items-center justify-between gap-2.5 cursor-pointer">
                  <span className="text-[11px] text-[#8E8E93] font-medium select-none">
                  ...
                  <div className="flex items-center gap-1 text-[#8E8E93]">
                    <button
                      ...
                      className={`p-1 ${currentTheme.buttonRadius} hover:text-emerald-400 hover:bg-white/10 transition`}
                      title="New checklist"
                    >
                      <ListChecks size={14} />
                    </button>
                    <button
                      ...
                      className={`p-1 ${currentTheme.buttonRadius} hover:text-white hover:bg-white/10 transition`}
                      title="New task"
                    >
                      <CheckSquare size={14} />
                    </button>
                ...
                <div className="p-3 space-y-2 animate-in fade-in duration-150">
                  ...
                  <div className="flex items-center justify-between gap-1.5">
                    <input
                      ...
                      placeholder="Title"
                      className={`w-full bg-transparent font-bold text-xs ${composerColorStyle.textColor} placeholder:text-[#64748B] focus:outline-none`}
                    />
                    <button
                      type="button"
                      onClick={() => {
                  ...
                  {newType === 'checklist' ? (
                    <div className="space-y-1.5 py-0.5">
                      {newChecklistItems.map((item, idx) => (
                        <div key={item.id} className="flex items-center gap-1.5 group/chk">
                          <button
                            type="button"
                            onClick={() => {
                              audio.playTap();
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-1.5 pt-1.5 border-t border-black/10 dark:border-white/10">
                    <div className="flex items-center gap-1 relative">
                      ...
                      <div className="flex items-center gap-0.5 bg-black/20 p-0.5 rounded-lg border border-white/10">
                        ...
                        >
                          <ListChecks size={10} className={newType === 'checklist' ? 'text-emerald-400' : ''} />
                          <span>Checklist</span>
                        </button>
                      </div>
                      ...
                      <button
                        ...
                        className={`p-1 ${currentTheme.buttonRadius} text-[#8E8E93] hover:text-white hover:bg-white/10 transition`}
                        title="Color palette"
                      >
                        <Palette size={12} />
                      </button>
                      ...
                      {showColorPickerForNew && (
                        <div className="absolute left-0 bottom-7 z-30 p-1 flex items-center gap-1 bg-[#161B26] border border-white/15 rounded-lg shadow-xl animate-in zoom-in-95">
                          {NOTE_COLOR_KEYS.map((c) => {
                            const cInfo = getNoteColorStyle(c, settings.theme);
                            return (
                              <button
