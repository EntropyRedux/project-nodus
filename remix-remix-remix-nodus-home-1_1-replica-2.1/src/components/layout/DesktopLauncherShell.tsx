...
export const DesktopLauncherShell: React.FC = () => {
  ...
  const folderCardClass = {
    ...
    material: 'rounded-3xl bg-[#F0F4F9]/90 hover:bg-[#E8EDF5] border border-[#E0E2EC] shadow-sm',
  ...
  const windowModalClass = {
    ...
    material: 'rounded-3xl border border-[#E0E2EC] shadow-[0_20px_60px_rgba(0,0,0,0.12)]',
  }[currentTheme.archetype];
  ...
  return (
    ...
    >
              ...
              {currentFolders.map((folder) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-[11px] desktop-icon-label mt-1.5 truncate w-full max-w-[80px] text-center select-none leading-tight tracking-tight">
                      {folder.name}
                    </span>
                  </div>
                );
      ...
      {/* Right Desktop Column: Cross-Device Clipboard Panel (Active only when Nodus Fleet is enabled) */}
