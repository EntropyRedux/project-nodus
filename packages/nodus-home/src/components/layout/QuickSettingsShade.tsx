      ...
      <div className="p-3 rounded-2xl bg-[#1C1C1E] border border-white/5 flex items-center justify-between my-2 shadow-xl">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <h4 className="text-xs font-semibold text-[#F0F0F2] truncate">{currentTrack?.title || 'Solar Echoes'}</h4>
            ...
            <div
              ...
              onClick={() => {
                ...
                try {
                  ...
                  if (bridge?.launchNotification && bridge.launchNotification(notif.id)) {
                    return;
                  }
                } catch (_) {}
